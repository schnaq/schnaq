...
`./resources/public/node_modules/purgecss/bin/purgecss.js -css resources/public/css/main.min.css --content resources/public/js/compiled/base.js --rejected`

This will output all unused css classes.
