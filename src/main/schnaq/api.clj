...
(defn- say-hello
  ...
  (log/info (format "[Stripe] Price ID schnaq pro monthly: %s" (:schnaq.pro/monthly shared-config/stripe-prices)))
  (log/info (format "[Stripe] Price ID schnaq pro yearly: %s" (:schnaq.pro/yearly shared-config/stripe-prices)))
