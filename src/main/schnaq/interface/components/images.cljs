...
(defn img-path
  ...
  (identifier
    {:alphazulu/logo "https://s3.disqtec.com/alphazulu/alphazulu_logo.png"
     ...
     :icon-cards-dark "https://s3.disqtec.com/schnaq-common/icons/squares_dark.svg"
     ...
     :icon-qanda-dark "https://s3.disqtec.com/schnaq-common/icons/qanda_dark.svg"
     ...
     :schnaqqifant/three-d-head "https://s3.disqtec.com/schnaq-schnaqqifanten/schnaqqi-3d-head.png"
     :schnaqqifant/three-d-left "https://s3.disqtec.com/schnaq-schnaqqifanten/schnaqqi-3d-head-left.png"
