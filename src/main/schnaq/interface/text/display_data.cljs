  ...
  {:en {;; Common
   ...
   Take a look how the price of schnaq compares to Miro + Loomio + Confluence together."
     ...
     if you are paying monthly. If you are paying yearly, you can cancel at the end of the subscription year."]
        ...
        :summary.user/privacy-warning "This function is currently in a beta phase. For the purpose of improving the quality of the function, schnaq employees will be able to discreetly view the summaries contents."
