  ...
  (identifier
    {
     ...
     :how-to.startpage/body "Sie möchten losschnaqqen, sind aber unsicher wie Sie schnaq zu bedienen haben? Wir haben eine ausführliche Anleitung mit kurzen Videos erstellt, um Ihnen den Einstieg zu erleichtern."
     ...
     :how-to.create/body "Legen Sie zuerst ein schnaq an. Geben Sie ihrem schnaq danach einen Titel und eine Beschreibung. Sie können auch Bilder und Dokumente verlinken."
     :how-to.agenda/title "Agenda erstellen"
     :how-to.agenda/body "Sie können mehrere Agendapunkte anlegen um ihr schnaq granularer zu planen und um Themen einzelnd zu diskutieren."
     :how-to.admin/title "Teilnehmende einladen"
     :how-to.admin/body "Teilnehmende können entweder per Link oder Mail eingeladen werden. Weitere Admins laden Sie über den Admin Zugang ein. Administrierende können ebenfalls Teilnehmende einladen oder das schnaq editieren."
     :how-to.call-to-action/title "Genug gequatscht, jetzt wird geschnaqqt!"
     :how-to.call-to-action/body "Starten Sie jetzt ihr schnaq bequem mit einem Klick! Laden Sie Teilnehmende ein und diskutieren Sie Vorschläge untereinander. Kollaborative Vorbereitung ohne Hürden, ganz einfach gemacht."
