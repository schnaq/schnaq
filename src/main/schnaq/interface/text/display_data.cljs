  ...
  (identifier
    {
     ...
     :feature.meetings.schedule/lead "Mitarbeiter:innen aktivieren"
     ...
     :feature.meetings.discuss/body "Bei Punkten, die nicht klar umrissen sind bietet sich eine Online-Diskussion. Diese kann man direkt über die vorgeschlagenen Agenda-Punkte erreichen und Ad-hoc erledigen. Die Diskussion kann der Ausrichtung einer Agenda dienen, aber auch der Klärung von offenen Punkten, bei denen nicht klar ist wie die Agenda gestaltet werden sollte. Dies geschieht strukturiert und asynchron, so dass alle Mitarbeiter:innen teilnehmen können. Das Ergebnis sind fokussierte Meetings."
