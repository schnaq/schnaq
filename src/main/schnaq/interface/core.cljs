(ns schnaq.interface.core
  (:require ["@fortawesome/fontawesome-free/js/all.js"]
            ...
            [schnaq.interface.views.discussion.cards.card-elements]
            [schnaq.interface.views.discussion.cards.card-view]
            [schnaq.interface.views.discussion.cards.conclusion-card]
