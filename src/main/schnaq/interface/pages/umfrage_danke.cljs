   ...
   [:div.col
    [:form
     ...
     [:ul {:area-hidden "true" :style {:display "none"}}
      [:li [:input {:id "mce-group[295590]-295590-0" :checked true :type "checkbox" :value "1" :name "group[295590][1]" :tabIndex "-1"}]
       [:label {:for "mce-group[295590]-295590-0"} "Wissensmanagement"]]
      [:li [:input {:id "mce-group[295590]-295590-1" :type "checkbox" :value "2" :name "group[295590][2]" :tabIndex "-1"}]
       [:label {:for "mce-group[295590]-295590-1"} "Consulting"]]
      [:li [:input {:id "mce-group[295590]-295590-2" :type "checkbox" :value "4" :name "group[295590][4]" :tabIndex "-1"}]
       [:label {:for "mce-group[295590]-295590-2"} "E-Learning"]]
      [:li [:input {:id "mce-group[295590]-295590-3" :type "checkbox" :value "8" :name "group[295590][8]" :tabIndex "-1"}]
