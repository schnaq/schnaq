...
(def labels
  {:error/export-failed "Export failed. Please try again later."
   ...
   :productpage.overview.activation/text "Get your participants actively involved in your event! Concentration warning? Increase their attention with a short action! Let them react at the touch of a button."
