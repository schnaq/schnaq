...
(def labels
  {:error/export-failed "Export failed. Please try again later."
   ...
   :schnaq.moderation.configurations.read-only/explanation "When checked, users can no longer add new posts to the discussion. Existing posts are still readable and can be analysed. You can change this option anytime."
   :schnaq.moderation.configurations.disable-pro-con/label "Disable agree/disagree button"
   :schnaq.moderation.configurations.disable-pro-con/explanation "When checked, users can no longer use the agree/disagree button. New posts will be handled as agreement. You can change this option anytime."
   ...
   :schnaq.moderation.edit.link.form/label "Email address of new moderators"
   :schnaq.moderation.edit.link.form/placeholder "Enter an email address"
   :schnaq.moderation.edit.link.form/submit-button "Send link"
   :schnaq.admin.invite/via-link "Distribute Link"
   :schnaq.moderation.edit/administrate "Configure schnaq"
