...
(def labels
  {:error/export-failed "Export failed. Please try again later."
   ...
   :schnaq.admin.edit.link/header "Invite moderators"
   :schnaq.admin.edit.link/primer "Administration takes work, let others help!"
   :schnaq.admin.edit.link/admin "Share moderator-access via mail"
   :schnaq.admin.edit.link/admin-privileges "Edit and administer suggestions"
   :schnaq.admin.edit.link.form/label "Email address of new moderators"
   ...
   :schnaq.admin.edit/administrate "Configure schnaq"
