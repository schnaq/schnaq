...
Now we write down questions and discuss them and can still understand what we have decided three weeks later."
   ...
   :pricing.features/pro ["Unlimited schnaqs" "Unlimited Audience polls" "Personal Themes / Brandings" "Personal Spaces" "Analysis Dashboard" "A.I. Summaries" "Moderation Options" "Priority Support"]
   ...
   :pricing.table.number/infinite "Unlimited"
   :pricing.table.contact/sales "Contact Sales for more"
   :pricing.table.core/heading "Core Product"
   :pricing.table.core.schnaqs/name "Schnaqs"
   :pricing.table.core.schnaqs/description "Number of active schnaqs per account."
   :pricing.table.core.participants/name "Participants"
   :pricing.table.core.participants/description "Number of different devices per schnaq."
   :pricing.table.core.additional/name "Additional participants"
   :pricing.table.core.additional/description "Participants that can be booked in addition to the maximum."
   :pricing.table.core.activations/name "Activations"
   :pricing.table.core.activations/description "Methods to activate your audience. Number per schnaq."
   ...
   :pricing.table.qa.moderation/description "Various settings and options to efficiently moderate the schnaq, or set it up to your liking."
   :pricing.table.qa.answers/name "Answers"
   :pricing.table.qa.answers/description "Allow replies to posts directly in schnaq."
   :pricing.table.qa.automatic-answers/name "Automated question detection"
   :pricing.table.qa.automatic-answers/description "Let schnaq help you filter out questions in a discussion."
   :pricing.table.qa.mindmaps/name "Automatic mindmaps"
   :pricing.table.qa.mindmaps/description "Schnaq generates live and automatic mindmaps over all posts."
   :pricing.table.interaction/heading "Interaction"
   :pricing.table.interaction.polls/name "Quick Polls"
   :pricing.table.interaction.polls/description "Let your audience vote on anything you want with just a few clicks."
   :pricing.table.interaction.activation/name "Quick Activation"
   :pricing.table.interaction.activation/description "Is your audience losing attention? Activate them within 2 seconds with the quick activation button."
   :pricing.table.interaction.word-cloud/name "Word clouds"
   :pricing.table.interaction.word-cloud/description "Visualize all posts in a word cloud."
   :pricing.table.interaction.rankings/name "Rankings"
   :pricing.table.interaction.rankings/description "Instead of normal polls, your audience can also rank different favorites."
   :pricing.table.security/heading "Security and privacy"
   :pricing.table.security.gdrp/name "DSGVO Compliant Data Handling"
   :pricing.table.security.gdrp/description "Schnaq handles data compliant to GDPR and all other European and German data protection laws."
   :pricing.table.security.germany/name "Hosting in a German Cloud"
   :pricing.table.security.germany/description "All data remains on the servers in the German Cloud at all times."
   :pricing.table.security.anon/name "Anonymous participation possible"
   :pricing.table.security.anon/description "Users can also participate anonymously without an account using the correct link or QR code."
   :pricing.table.security.code/name "Participation by code"
   :pricing.table.security.code/description "Your audience can also join your space by number code or QR code."
   :pricing.table.advanced/heading "Advanced features"
   :pricing.table.advanced.theming/name "Personalized design"
   :pricing.table.advanced.theming/description "Customize schnaq's look to reflect your brand. Easy with just a few clicks without a designer."
   :pricing.table.advanced.analytics/name "Analytics Dashboard"
   :pricing.table.advanced.analytics/description "See the most important data points about your schnaqs in one place."
   :pricing.table.advanced.summary/name "Summary A.I."
   :pricing.table.advanced.summary/description "An A.I. can fully automatically summarize your discussions in a few sentences. Always keep track!"
   ...
   :pricing.table.support.priority/name "Priority support"
   :pricing.table.support.priority/description "Your requests will immediately move to the front of the queue and be marked as important."
