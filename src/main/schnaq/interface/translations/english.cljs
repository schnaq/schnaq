...
Now we write down questions and discuss them and can still understand what we have decided three weeks later."
   ...
   :registration.register.input/email "Enter your email address here."
   :registration.register.input/password "Enter a password with at least %d characters"
   ...
   :registration.register.validation/password "Your password is not valid. It must be at least %d characters, but it only has %d characters."
   ...
   :registration.survey.options/fairs "Fairs"
