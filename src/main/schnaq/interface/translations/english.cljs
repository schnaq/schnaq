...
Now we write down questions and discuss them and can still understand what we have decided three weeks later."
   ...
   :pricing.table.security.gdpr/name "DSGVO Compliant Data Handling"
   :pricing.table.security.gdpr/description "Schnaq handles data compliant to GDPR and all other European and German data protection laws."
