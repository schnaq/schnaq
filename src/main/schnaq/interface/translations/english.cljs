...
Now we write down questions and discuss them and can still understand what we have decided three weeks later."
   ...
   :themes.personal.creation/lead "Set the colour scheme for your schnaqs here. After you have created your theme here, you can select the theme in your schnaq's settings."
   ...
   :themes.personal.creation.logo/title "Logo"
   :themes.personal.creation.activation.image/title "Activation image"
   :themes.personal.creation.preview-image/title "Logo"
   :themes.personal.creation.colors/title "Colour Settings"
   ...
   :themes.schnaq.settings/lead "Once you have selected a theme, it will be saved for this schnaq. Your visitors will then see the new colour scheme the next time they load the schnaq."
