...
(def labels
  {:error/export-failed "Eksport nie zadziałał, spróbuj ponownie później."
   ...
   :nav/blog "Blog"
   :nav/admin "Admin"
   :nav/register "Zarejestruj się bezpłatnie"
   ...
   :analytics/labels-stats "Zaznaczone odpowiedzi"
   ...
   :pricing.pro-tier/call-to-action "Zarezerwuj teraz Pro"
   :pricing.pro-tier/already-subscribed "Jesteś już pro-użytkownikiem. Czy chcesz przejść do ustawień subskrypcji?"
   :pricing.pro-tier/go-to-settings "Przejdź do swoich ustawień"
