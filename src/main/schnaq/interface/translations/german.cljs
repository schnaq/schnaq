...
(def labels
  {:error/export-failed "Export hat nicht geklappt, versuche es später erneut."
   ...
   :registration.register.input/email "Gib hier deine E-Mail-Adresse ein"
   :registration.register.input/password "Vergib ein mindestens %d-Zeichen langes Passwort"
