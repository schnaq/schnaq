...
(def labels
  {:error/export-failed "Export hat nicht geklappt, versuche es später erneut."
   ...
   :pricing.table.qa.automatic-answers/description "Lasse dir von schnaq helfen Fragen in einer Diskussion rauszufiltern"
   :pricing.table.qa.mindmaps/name "Automatische Mindmaps"
   :pricing.table.qa.mindmaps/description "Schnaq generiert live und automatisch Mindmaps übner alle Beiträge"
   ...
   :pricing.table.interaction.word-cloud/description "Visualisiere alle Beiträge als eine Wortwolke"
   ...
   :pricing.table.security.gdrp/name "DSGVO Konformes Datenhandling"
   :pricing.table.security.gdrp/description "Schnaq behandelt Daten konform zu der DSGVO und allen anderen Europäischen und Deutschen Datenschutzgesetzen"
