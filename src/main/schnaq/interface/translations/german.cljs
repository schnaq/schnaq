...
(def labels
  {:error/export-failed "Export hat nicht geklappt, versuche es später erneut."
   ...
   :schnaq.moderation.configurations.read-only/explanation "Aktivieren, um keine neuen Beiträge zu erlauben. Bestehende Beiträge sind weiterhin sichtbar und können weiterhin analysiert werden. Diese Option kann jederzeit geändert werden."
   :schnaq.moderation.configurations.disable-pro-con/label "Dafür/Dagegen Knopf ausblenden"
   :schnaq.moderation.configurations.disable-pro-con/explanation "Aktivieren, um den  Dafür/Dagegen Knopf nicht mehr anzuzeigen. Neue Beiträge werden als Zustimmung gewertet. Diese Option kann jederzeit geändert werden."
   :schnaq.moderation.configurations.mods-mark-only/label "Nur Moderator:innen Antworten markieren lassen"
   :schnaq.moderation.configurations.mods-mark-only/explanation "Wenn aktiviert, haben nur Moderatoren die Möglichkeit Antworten als korrekt zu markieren."
   ...
   :schnaq.moderation.edit.link.form/label "E-Mail Adresse der Moderator:innen"
   :schnaq.moderation.edit.link.form/placeholder "Eine E-Mailadresse eingeben"
   :schnaq.moderation.edit.link.form/submit-button "Link verschicken"
